...
const PkgScrollDownBtn = () => {
    return (
        <div className='d-flex justify-content-center align-items-center' style={{ height: "100%", width: "100%" }}>
            ...
            <div className="scrll-btn-outer" style={{ height: "80%", width: "43%", backgroundColor: "rgba(0,0,0,0.5)", borderRadius: "50%", border: "2px dashed #fff" }}>

            </div>
            <div className="scroll-arrow" style={{position:"relative", left:"-78px"}}>
