...
const BlogBanner = () => {
    return (
        <div className="about-banner my-2 d-flex justify-content-center align-items-center" style={{ width: "100%", height: "41vh", backgroundImage: `url(${visaBanner})`, backgroundSize:"cover", backgroundRepeat: "no-repeat" }}>
