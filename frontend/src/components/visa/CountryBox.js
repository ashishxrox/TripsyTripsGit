    ...
    return (
        <div className='col-md-3 my-1' style={{ height: "450px", overflow: "hidden", borderRadius: "8px" }}>
            <div className='card-hover' style={{ height: "100%", width: "100%", borderRadius: "8px" }}>
                <Link to={{ pathname: `/visa/application/${country.country}`, state: country }} state={country} className="card country-card" style={{ height: "26rem", background: "#fff", overflow: "hidden" }}>
                    ...
                    <div className="overlay py-4" style={overlayStyle}>
                        <div className='d-flex justify-content-center align-items-center' style={{ position: "relative", bottom: "15px", fontSize: "20px", fontWeight: "500" }}>
