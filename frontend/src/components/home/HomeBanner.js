    ...
    return (
        <div className="home-banner" style={myStyle}>
            <div className="img-box d-flex justify-content-center" style={{ width: "100%", backgroundImage: `url(${Landing})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center" }}>
                ...
                <div className='d-flex justify-content-center align-items-start' style={{ position: "relative", top: 0, left: 0, width: "100%", height: "100%", background: "radial-gradient(circle, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.1) 70%, rgba(0,0,0,0) 100%)" }}>
                    <div className="landing-text d-flex justify-content-between flex-column align-items-center" style={{ height: "150px", color: "#fff", top: "150px", position: "relative" }}>
                        <h1 style={{ fontFamily: "Clash Display", lineHeight: "74px", textAlign: "center" }}>Let's Travel The World</h1>
                        <h5>Dream It. Plan It. Book It.</h5>
                    </div>
                </div>
