  ...
  return (
    <div className='my-revs py-5' style={{ background: "transparents" }}>
      <div className="row1" style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-around", flexDirection: "column" }}>
        <div className="col my-5 d-flex justify-content-center align-items-center" style={{ width: "100%" }}>
          <div className="reviews-cont d-flex justify-content-between align-items-center" style={{ height: "100%" }}>
            <div className="review-cont-left  d-flex justify-content-between flex-column align-items-center" style={{ flexBasis: "49%", width: "100%", height: "100%" }}>
              ...
              <div className="rcl-content my-3 d-flex  align-items-center" style={{ flexBasis: "60%", height: "100%", width: "100%" }}>
                <div className="rclc-left mx-1 d-flex justify-content-center align-items-start flex-column" style={{ flexBasis: "30%", height: "100%", width: "100%", backgroundColor: "#fff" }}>
                ...
                <div className="rclc-left mx-1 d-flex justify-content-center align-items-start flex-column" style={{ flexBasis: "30%", height: "100%", width: "100%", backgroundColor: "#fff" }}>
                  <h4 style={{ fontFamily: "Clash Display", fontSize: "34px", fontWeight: "500", color: "rgba(116, 138, 152, 1)" }}>23</h4><h6 style={{ fontSize: "18px", fontWeight: "500" }}>Reviews</h6>
                </div>
                <div className="rclc-left mx-1 d-flex justify-content-center align-items-start flex-column" style={{ flexBasis: "30%", height: "100%", width: "100%", backgroundColor: "#fff" }}>
              ...
              <div className="rcl-btn my-3 d-flex align-items-start" style={{ flexBasis: "20%", height: "100%", width: "100%" }}>
                <div className='rclb-btn d-flex justify-content-center align-items-center' style={{ cursor: "pointer", height: "65px",width:"175px", padding:"10px 10px",border: "1px solid rgba(2, 71, 134, 1)", borderRadius: "30px", transition:"1s" }}>
        ...
        <div className="home-blogs my-5 d-flex justify-content-center align-items-center" style={{ width: "100%" }}>
          <div className="home-blogs-cont  d-flex justify-content-between flex-column align-items-center" style={{ width: "85%", height: "100%" }}>
            ...
            <div className="blogs-main-content d-flex justify-content-between align-items-center my-2" style={{ flexBasis: "80%", height: "100%", width: "100%" }}>
              <div className="blogs-main-content-left d-flex justify-content-between align-items-center flex-column" style={{ flexBasis: "49.5%", border: "1px solid #000", height: "100%", width: "100%", borderRadius: "15px" }}>
                ...
                <div className="bmcl-bottom d-flex justify-content-between align-items-center py-4 px-3" style={{ height: "100%", width: "100%", overflow: "none" }}>
                  <div className="bmcl-b-left mx-1 d-flex align-items-start flex-column" style={{ flexBasis: "80%", height: "100%", width: "100%" }}>
                    ...
                    <div className='d-flex justify-content-between align-items-start flex-row' style={{ width: "50%" }}>
                      <p className='py-2 px-4 mx-1' style={{ backgroundColor: "rgba(243, 236, 230, 1)", borderRadius: "30px" }}>Travel</p>
                      <p className='py-2 px-4' style={{ backgroundColor: "rgba(243, 236, 230, 1)", borderRadius: "30px" }}>Nature</p>
                      <p className='py-2 px-4 mx-1' style={{ backgroundColor: "rgba(243, 236, 230, 1)", borderRadius: "30px" }}>Environmental</p>
                    </div>
                  </div>
        ...
        <div className="blogs-btn d-flex justify-content-center align-items-center my-5" style={{ height: "10vh", width: "100%" }}>
          <div className="blogs-btn-cont d-flex justify-content-center align-items-center" style={{ height: "70%", width: "200px", borderRadius: "30px", border: "1px solid rgba(2, 71, 134, 1)" }}>
            <a href="#" style={{ color: "rgba(2, 71, 134, 1)", textDecoration: "none", fontSize: "16px" }}>  Read more blogs</a>
          </div>
        </div>
        <div className="tripsy-insta-title d-flex justify-content-between align-items-center" style={{ height: "20vh", width: "85%" }}>
          <div className="insta-title-left d-flex justify-content-start align-items-end" style={{ height: "100%" }}>
            <h3 style={{ fontFamily: "Clash Display", fontWeight: "500" }}>Check out our Instgram</h3>
          </div>
